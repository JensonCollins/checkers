...
func (m *NextGame) GetFifoHeadIndex() string {
	if m != nil {
...
func (m *NextGame) GetFifoTailIndex() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*NextGame)(nil), "jensoncollins.checkers.checkers.NextGame")
}
...
var fileDescriptor_c12fafd6c218bc9c = []byte{
	...
	0x28, 0xca, 0x2f, 0xc9, 0x17, 0x92, 0xcf, 0x4a, 0xcd, 0x2b, 0xce, 0xcf, 0x4b, 0xce, 0xcf, 0xc9,
	0xc9, 0xcc, 0x2b, 0xd6, 0x83, 0xa9, 0x83, 0x33, 0x94, 0xba, 0x18, 0xb9, 0x38, 0xfc, 0x52, 0x2b,
	0x4a, 0xdc, 0x13, 0x73, 0x53, 0x85, 0x24, 0xb8, 0xd8, 0x93, 0x8b, 0x52, 0x13, 0x4b, 0xf2, 0x8b,
	0x24, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0x60, 0x5c, 0x90, 0x4c, 0x66, 0x4a, 0x58, 0x62, 0x4e,
	0x69, 0xaa, 0x04, 0x93, 0x02, 0xa3, 0x06, 0x4b, 0x10, 0x8c, 0x2b, 0xa4, 0xc2, 0xc5, 0x9b, 0x96,
	0x99, 0x96, 0xef, 0x91, 0x9a, 0x98, 0xe2, 0x99, 0x97, 0x92, 0x5a, 0x21, 0xc1, 0x0c, 0xd6, 0x89,
	0x2a, 0x08, 0x53, 0x15, 0x92, 0x98, 0x99, 0x03, 0x51, 0xc5, 0x82, 0x50, 0x05, 0x17, 0x74, 0xf2,
	...
	0xd2, 0x24, 0xbd, 0xe4, 0xfc, 0x5c, 0x7d, 0x2f, 0xb0, 0x97, 0x9c, 0x21, 0x5e, 0xd2, 0x87, 0x7b,
	0xbd, 0x02, 0xc1, 0x2c, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x07, 0x81, 0x31, 0x20, 0x00,
	0x00, 0xff, 0xff, 0x9b, 0x27, 0x1d, 0x01, 0x1e, 0x01, 0x00, 0x00,
}
...
func (m *NextGame) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FifoTailIndex) > 0 {
		...
		i = encodeVarintNextGame(dAtA, i, uint64(len(m.FifoTailIndex)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.FifoHeadIndex) > 0 {
		...
		i = encodeVarintNextGame(dAtA, i, uint64(len(m.FifoHeadIndex)))
		i--
		dAtA[i] = 0x1a
	}
	if m.IdValue != 0 {
